...
function RightContainer:paintTo(bb, x, y)
    ...
    if self.bordersize > 0 then
        bb:paintBorder(x + self.margin + (self.dimen.w - content_size_width),
    ...
    self[1]:paintTo(bb,
        x + self.padding + self.margin + self.bordersize + (self.dimen.w - content_size_width),
        y + self.padding + self.margin + self.bordersize + math.floor((self.dimen.h - content_size_height) / 2))
end
